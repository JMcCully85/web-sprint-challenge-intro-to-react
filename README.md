...
React helps with not overloading the dom by using a virtual dom and makes it easier to create elements on the dom

1. Describe component state.

Component state is what our components get passed from whatever is calling them.

1. Describe props.

Props is the way we pass dates

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?

useEffect helps with syncing data and we could use async to help it do that.
